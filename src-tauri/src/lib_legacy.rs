// ARCHIVE NOTICE
// This file is a legacy snapshot kept for reference only.
// Active backend entrypoint: src-tauri/src/lib.rs
// Do not add new features here unless explicitly requested.
